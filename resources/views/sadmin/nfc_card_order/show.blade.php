                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                    <label for="name"
                                        ...
                                        <a href="{{ $nfcCardOrder->getMedia('nfc_order_logo')->first()->getFullUrl() }}" download="{{ $nfcCardOrder->getMedia('nfc_order_logo')->first()->file_name }}" class="btn btn-primary mt-2" style="width:150px">
