<div class="row">
    ...
    <div class="form-group col-md-12 mb-10">
        <div class="row">
            @foreach(getTemplateUrls() as $id => $url)
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 img-box mb-2">
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-3 col-md-4 col-6 mb-5 col-xs">
            <label class="form-label form-check">
                <input class="form-check-input feature mx-2" type="checkbox" value="1"
                       name="order_nfc_card" {{ (isset($feature) && $feature->order_nfc_card == 1) ? 'checked' : '' }}/>
                       {{ __('messages.feature.order_nfc_card') }}
            </label>
        </div>
    </div>
    <div>
