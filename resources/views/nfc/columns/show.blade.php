                            ...
                            <div class="row">
                                ...
                                @if (!@empty($nfcCardOrder->vcard->name))
                                    <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                        ...
                                        <span class="fs-4"><a href="{{ route('vcard.show', ['alias' => $nfcCardOrder->vcard->url_alias]) }}" class="text-info-800 text-decoration-none" target="_blank">{{ $nfcCardOrder->vcard->name }}</a></span>
                                    </div>
                                @endif
                                <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                    <label for="name"
