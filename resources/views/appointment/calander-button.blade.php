    ...
    <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
        ...
        <div class="p-5">
            <div class="mb-5">
                ...
                {{ Form::select('type', \app\models\ScheduleAppointment::TYPES, null,['class' => 'form-control form-select','data-control'=>"select2" ,'id' => 'appointmentType', 'wire:ignore']) }}
            </div>
            <div class="mb-5">
                <label for="exampleInputSelect2" class="form-label">{{__('messages.common.status')}}</label>
                {{ Form::select('type', \app\models\ScheduleAppointment::STATUS, null,['class' => 'form-control form-select','data-control'=>"select2" ,'id' => 'appointmentStatus', 'wire:ignore']) }}
            </div>
