        ...
        <div class="main-content mx-auto w-100 overflow-hidden border">
            <div class="banner-section position-relative">
                <div class="banner-img">
                    <img src="{{ asset('assets/img/vcard17/banner.png') }}" class="w-100 h-100 object-fit-cover" />
                    ...
                    <div class="gallery-slider">
                        <div class="slide">
                            <div class="gallery-img">
                                <img src="{{ asset('assets/img/vcard17/gallery-img1.png') }}" />
                            </div>
                        </div>
                        <div class="slide">
                            <div class="gallery-img">
                                <img src="{{ asset('assets/img/vcard17/gallery-img2.png') }}" />
                            </div>
                        </div>
                        <div class="slide">
                            <div class="gallery-img">
                                <img src="{{ asset('assets/img/vcard17/gallery-img3.png') }}" />
                            </div>
                        </div>
                        <div class="slide">
                            <div class="gallery-img">
            ...
            <div class="testimonial-section">
                ...
                <div class="qr-code-section pt-60 pb-60">
                    <div class="qr-bg-img">
                ...
                <div class="contact-us-section px-30">
                    ...
                    <div class="contact-form">
                        <div class="contact-icon">
                            <img src="{{ asset('assets/img/vcard17/contact-icon.png') }}" />
                        </div>
                        <form action="">
                            <div class="row">
                                <div class="col-12">
