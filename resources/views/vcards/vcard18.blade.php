      ...
      <div class="main-content mx-auto w-100 overflow-hidden">
        <div class="banner-section">
            <div class="banner-img">
                <img src="{{ asset('assets/img/vcard18/banner-img.png') }}" class="w-100 h-100 object-fit-cover" alt="">  </div>
          <img
        ...
        <div class="blog-section pt-60 px-sm-4 px-1">
          <div class="blog-bg">
            <img src="{{ asset('assets//img/vcard18/blog-bg.png') }}" />
          </div>
            ...
            <div class="px-3">
              <div class="testimonial-card">
                <div class="card-img mb-3">
                  <img src="{{ asset('assets//img/vcard18/testimonial.png') }}" />
                </div>
