      ...
      <div class="main-content mx-auto w-100 overflow-hidden">
        <div class="banner-section position-relative">
          <div class="banner-img">
            <img src="{{asset('assets/img/vcard15/Banner.png')}}" class="img-fluid" />
        ...
        <div class="bg-primary">
          <div class="profile-section pb-60 px-30">
            <div class="card">
              ...
              >
                <img src="{{asset('assets/img/vcard15/profile.png')}}" class="img-fluid" />
              </div>
          ...
          <div class="gallery-slider">
            <div class="slide">
              <div class="gallery-img">
                <img src="{{asset('assets/img/vcard15/gallery-img1.png')}}" />
              </div>
            </div>

            <div class="slide">
              <div class="gallery-img">
                <img src="{{asset('assets/img/vcard15/gallery-img2.png')}}" />
              </div>
            </div>

            <div class="slide">
              <div class="gallery-img">
                <img src="{{asset('assets/img/vcard15/gallery-img3.png')}}" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="">
                ...
                >
                  ...
                  <div class="card-body p-0">
                    <div class="quote-img">
                      <img src="{{asset('assets/img/vcard15/quote-img.png')}}" class="h-100" />
                    </div>
          ...
          <div class="blog-slider">
            <div class="">
              <div class="blog-card card">
                <div class="card-img">
                  <img src="{{asset('assets/img/vcard15/blog-img1.png')}}" class="h-100" />
                </div>
                <div class="card-body">
            ...
            <div class="">
              <div class="blog-card card">
                <div class="card-img">
                  <img src="{{asset('assets/img/vcard15/blog-img2.png')}}" class="h-100" />
                </div>
                <div class="card-body">
          ...
          <div class="px-30">
            ...
            >
              <div class="qr-code-img">
                <img src="{{asset('assets/img/vcard15/qr-code.png')}}" />
              </div>
            </div>
          </div>
        </div>
