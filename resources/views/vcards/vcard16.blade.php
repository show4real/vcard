        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
            <div class="banner-section w-100">
                <div class="banner-img">
                    <img src="{{ asset('assets/img/vcard16/banner.png') }}" class="object-fit-cover w-100 h-100" />
                    ...
                    <div class="col-sm-8">
                        <div class="card flex-sm-row">
                            <div class="card-img d-flex justify-content-center align-items-center">
                                <img src="{{ asset('assets/img/vcard16/profile.png') }}" class="img-fluid h-100 object-fit-cover" />
                            </div>
                        ...
                        <div class="col-sm-6 mb-sm-0 mb-40">
                            <div class="service-card card h-100 align-items-center">
                                <div class="card-img d-flex justify-content-center align-items-center object-fit-cover">
                                    <img src="{{ asset('assets/img/vcard16/service-img.png') }}" alt="" class="" />
                                </div>
            ...
            <div class="product-section pt-40 pb-30">
                ...
                <div class="product-slider px-4">
                    <div class="">
                        <div class="product-card card">
                            <div class="product-img card-img">
                                <img src="{{ asset('assets/img/vcard16/product-img1.png') }}" class="w-100 h-100 object-fit-cover" />
                            </div>
                    ...
                    <div class="">
                        <div class="product-card card">
                            <div class="product-img card-img">
                                <img src="{{ asset('assets/img/vcard16/product-img2.png') }}" class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div class="product-desc card-body d-flex align-items-center justify-content-between">
                                <div class="product-title">
            ...
            <div class="blog-section pt-40 pb-50 bg-gray-200">
                ...
                <div class="blog-slider px-4">
                    <div class="">
                        <div class="blog-card card flex-sm-row align-items-center">
                            <div class="card-img">
                                <img src="{{ asset('assets/img/vcard16/gallery-img3.png') }}" class="img-fluid h-100 object-fit-cover">
                            </div>
                ...
                <div class="blog-bg">
                    <img src="../images/lawyers/blog-bg-img.png">
                </div>
            </div>
                        ...
                        <div class="col-sm-5">
                            <div
                                ...
                                <div class="qr-code-img">
                                    <img src="{{ asset('assets/img/vcard16/qr-code.png') }}" class="w-100 h-100 object-fit-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
