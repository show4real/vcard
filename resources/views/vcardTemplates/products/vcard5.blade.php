...
<body>
    <div class="container p-0 main-section">
        <div class="vcard-five main-content mx-auto content-blur allSection collapse show">

            <div class="vcard-one__product py-3 mb-10 mt-0 main-bg ">
                                    ...
                                    <div class="card product-card p-2 border-0 h-100">
                                        <div class="product-profile d-flex justify-content-center">
                                            <img src="{{ $product->product_icon }}" alt="profile"
                                                class="object-fit-cover" height="208px" />
                                        </div>
