...
listen('click', '.duplicate-vcard-btn', function (event) {
    ...
    swal({
        title: Lang.get('messages.common.duplicate'),
        text: Lang.get('messages.common.are_you_sure_dublicate_vcard'),
        buttons: {
            confirm: Lang.get('messages.common.duplicate'),
...
function duplicateItemAjax (id, url) {
    $.ajax({
        ...
        success: function (obj) {
            ...
            swal({
                icon: 'success',
                title: Lang.get('messages.vcard.duplicate_vcard'),
                text: Lang.get('messages.common.duplicate_vcard_create'),
                timer: 2000,
                buttons: {
